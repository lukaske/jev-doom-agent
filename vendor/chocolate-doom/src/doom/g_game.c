...
// Browser automation writes the same per-engine key state consumed by
// G_BuildTiccmd. Each WebAssembly module owns a separate copy of this array.
void G_PromptFPSSetKey(int key, boolean down)
{
